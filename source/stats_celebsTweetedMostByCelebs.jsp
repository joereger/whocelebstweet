...
<%
String filename = "celebsTweetedMostByCelebs";
String typeTitle = ""+Pagez.getUserSession().getPl().getCelebiscalled()+"s tweeted the most by "+Pagez.getUserSession().getPl().getCelebiscalled()+"s";
String titleTime = "";
if (1==1){
                ...
                <table cellpadding="3" cellspacing="0" border="0" width="100%">
                    <tr>
                        <td valign="top">
                            ...
                            <br clear="all"/><br/><br/>
                            <%=StatsOutputCached.celebsTweetedMostByCelebs(Pagez.getUserSession().getPl(), request.getParameter("time"), 500, Util.booleanFromString(request.getParameter("refresh")), true)%>
                        </td>
                        <td valign="top">
