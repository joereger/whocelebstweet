...
%>
<%
String filename = "nonCelebsTweetedMostByTwit";
String typeTitle = "non-"+Pagez.getUserSession().getPl().getCelebiscalled()+"s tweeted most by @"+pagetitleName+"";
String titleTime = "";
if (1==1){
            ...
            <table cellpadding="3" cellspacing="0" border="0" width="100%">
                <tr>
                    <td valign="top">
                        ...
                        <br clear="all"/><br/><br/>
                        <%=StatsOutputCached.nonCelebsTweetedMostByTwit(twit, twitterusername, Pagez.getUserSession().getPl(), request.getParameter("time"), 500, Util.booleanFromString(request.getParameter("refresh")), true)%>
                    </td>
                    <td valign="top">
