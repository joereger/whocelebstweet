...
<%
String filename = "nonCelebsTweetedByMostDifferentCelebs";
String typeTitle = "non-"+Pagez.getUserSession().getPl().getCelebiscalled()+"s tweeted by the most different "+Pagez.getUserSession().getPl().getCelebiscalled()+"s";
String titleTime = "";
if (1==1){
                ...
                <table cellpadding="3" cellspacing="0" border="0" width="100%">
                    <tr>
                        <td valign="top">
                            ...
                            <br clear="all"/><br/><br/>
                            <%=StatsOutputCached.nonCelebsTweetedByMostDifferentCelebs(Pagez.getUserSession().getPl(), request.getParameter("time"), 500, Util.booleanFromString(request.getParameter("refresh")), true)%>
                        </td>
                        <td valign="top">
