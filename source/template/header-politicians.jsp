...
<head>
    ...
    <%
        String finalTitle = Pagez.getUserSession().getPl().getName()+" - See Who Politicians Tweet on Twitter! Have they tweeted you?";
        if (Pagez.getUserSession().isSisterPl()){
            finalTitle = Pagez.getUserSession().getPl().getSistername()+" - Politicians on Twitter! What are they saying?";  
        }
        ...
        <table width="100%" cellspacing="0" border="0" cellpadding="5">
            <tr>
                <td width="480">
                    <a href="/">
                    <%if (!Pagez.getUserSession().isSisterPl()){%>
                        <img src="/images/logoPoliticians.gif" alt="<%=Pagez.getUserSession().getPl().getName()%>" width="478" height="132" border="0">
                    <%} else {%>
                        <img src="/images/logoPoliticiansSister.gif" alt="<%=Pagez.getUserSession().getPl().getSistername()%>" width="478" height="132" border="0">
                    <%}%>
                    </a>
                </td>
                <td align="right">
