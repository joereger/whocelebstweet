...
<head>
    ...
    <%
        String finalTitle = Pagez.getUserSession().getPl().getName()+" - Atlanta Social Media Experts";
        if (Pagez.getUserSession().isSisterPl()){
            finalTitle = Pagez.getUserSession().getPl().getSistername()+" - Atlanta Social Media Experts";  
        }
    ...
    <link rel="stylesheet" type="text/css" href="/css/AtlantaTechpundits.css"/>
    <meta name="description" content="<%=finalMetaDescription%>"/>
    <meta name="keywords" content="<%=finalMetaKeywords%> twitter twit tweet atlanta peach social media"/>
