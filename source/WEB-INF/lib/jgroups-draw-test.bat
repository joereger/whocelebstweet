...
set CPATH=./commons-logging-1.0.4.jar;./log4j-1.2.11.jar;./concurrent-1.3.2.jar;./jgroups-all.jar;
...
set PROPS=%PROPS%:pbcast.NAKACK(max_xmit_size=8096;gc_lag=50;retransmit_timeout=600,1200,2400,4800)
...
set PROPS=%PROPS%:pbcast.GMS(join_timeout=5000;join_retry_timeout=2000;shun=false;print_local_addr=true)
