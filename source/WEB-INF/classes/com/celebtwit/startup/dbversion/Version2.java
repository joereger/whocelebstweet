...
public class Version2 implements UpgradeDatabaseOneVersion {
    ...
    public void doPostHibernateUpgrade(){
        ...
        //-----------------------------------
        //-----------------------------------
        int count4 = Db.RunSQLUpdate("UPDATE pl set sistername='';");
        //-----------------------------------
        //-----------------------------------

        //-----------------------------------
        //-----------------------------------
        int coun1t = Db.RunSQLUpdate("UPDATE pl set sisterdomain1='';");
        //-----------------------------------
        //-----------------------------------

        //-----------------------------------
        //-----------------------------------
        int count2 = Db.RunSQLUpdate("UPDATE pl set sisterdomain2='';");
        //-----------------------------------
        //-----------------------------------

        //-----------------------------------
        //-----------------------------------
        int count3 = Db.RunSQLUpdate("UPDATE pl set sisterdomain3='';");
        //-----------------------------------
        //-----------------------------------
