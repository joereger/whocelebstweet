...
public class Version18 implements UpgradeDatabaseOneVersion {
    ...
    public void doPostHibernateUpgrade(){
        ...
        //-----------------------------------
        //-----------------------------------
        int countdddssf = Db.RunSQLUpdate("DELETE from keywordtwit");
        //-----------------------------------
        //-----------------------------------

        //-----------------------------------
        //-----------------------------------
        int countdddss9 = Db.RunSQLUpdate("UPDATE keyword SET sincetwitpostid='0'");
        //-----------------------------------
        //-----------------------------------

        //-----------------------------------
        //-----------------------------------
        int countdddss6 = Db.RunSQLUpdate("DELETE from dbcacheexpirable WHERE keyname LIKE '%CelebMentionsKeyword%'");
        //-----------------------------------
        //-----------------------------------

        //-----------------------------------
        //-----------------------------------
        int countdddss7 = Db.RunSQLUpdate("DELETE from dbcacheexpirable WHERE keyname LIKE '%CelebsSidebar%'");
        //-----------------------------------
        //-----------------------------------

        //-----------------------------------
        //-----------------------------------
        int countdddss8 = Db.RunSQLUpdate("DELETE from dbcacheexpirable WHERE keyname LIKE '%CelebsSubnav%'");
        //-----------------------------------
        //-----------------------------------
