...
public class CountMentionsByCelebs {
    ...
    public static int get(Twit twit, Date startDate, Date endDate){
        ...
        int out = NumFromUniqueResult.getInt("select sum(1) as numOfMentions from Mention mention where mention.twitidmentioned="+twit.getTwitid()+" and mention.created_at>'"+startDateStr+"' and mention.created_at<'"+endDateStr+"' ");
